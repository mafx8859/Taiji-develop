          ...
          <div class="box box-warning">
              <form class="form-horizontal clearfix" href="${pageContext.request.contextPath}/activity/new" method="post">
                  <div class="box-header with-border">
                      <h3 class="box-title">填写活动内容</h3>
                  </div>
                  <div class="box-body">

                      <div class="form-group clearfix">
                          <label class="col-sm-3 control-label">活动编号前缀：</label>
                          <div class="col-sm-6">
                              <input type="text" name="year" class="form-control require-text year" value="${year}">
                          </div>
                      </div>
                      <!--正则判断活动编号前缀 -->
                      ...
                      <div class="form-group clearfix">
                          ...
                          <div class="col-sm-6">
                              <input type="text" name="name" class="form-control require-text" placeholder="请输入...">
                          </div>
                      </div>
                      ...
                      <div class="form-group clearfix">
                          ...
                          <div class="col-sm-6">
                              <input type="text" class="form-control require-text" name="sponsor" placeholder="请输入...">
                          </div>
                      </div>
                      ...
                      <div class="form-group clearfix">
                          ...
                          <div class="col-sm-6">
                              <input type="text" class="form-control require-text" name="organization" placeholder="请输入...">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-6">
                              <div class="input-group">
                                  ...
                                  <input type="text" name="time" class="form-control pull-right" id="reservation">
                              </div>
                          </div>
                      </div>
                      <div class="form-group clearfix">
                          ...
                          <div class="col-sm-6">
                              <input type="text" class="form-control require-text" name="budget" placeholder="请输入...">
                          </div>
                      </div>
                      <div class="form-group clearfix">
                          <label class="col-sm-3 control-label">联系电话：</label>
                          <div class="col-sm-3">
                              <input type="text" class="form-control require-text" placeholder="请输入..." name="tel">
                          </div>
                          <label class="col-sm-1 control-label">联系QQ：</label>
                          <div class="col-sm-2">
                              <input type="text" class="form-control require-text" placeholder="请输入..." name="qq">
                          </div>
                      </div>
                      ...
                      <div class="form-group clearfix">
                          <div class="col-sm-6">
                              ...
                              <div class="radio radio-inline">
                                  <input type="radio" id="inlineRadio1" value="1" name="provideMeal" checked="checked">
                                  <label for="inlineRadio1"> 提供 </label>
                              </div>
                              <div class="radio radio-inline">
                                  <input type="radio" id="inlineRadio2" value="0" name="provideMeal">
                          ...
                          <div class="col-sm-6">
                              ...
                              <div class="radio radio-inline">
                                  <input type="radio" id="inlineRadio3" value="1" name="provideHotel" checked="checked">
                                  <label for="inlineRadio3"> 提供 </label>
                              </div>
                              <div class="radio radio-inline">
                                  <input type="radio" id="inlineRadio4" value="0" name="provideHotel">
                      ...
                      <div class="form-group clearfix">
                        ...
                        <div class="radio radio-inline">
                            <input type="radio" id="inlineRadio5" value="1" name="needIdCard" checked="checked">
                            <label for="inlineRadio5"> 需要 </label>
                        </div>
                        <div class="radio radio-inline">
                            <input type="radio" id="inlineRadio6" value="0" name="needIdCard">
                      ...
                      <div class="form-group clearfix">
                          ...
                          <div class="radio radio-inline">
                              <input type="radio" id="inlineRadio7" value="1" name="needHealth" checked="checked">
                              <label for="inlineRadio7"> 需要 </label>
                          </div>
                          <div class="radio radio-inline">
                              <input type="radio" id="inlineRadio8" value="0" name="needHealth">
                      ...
                      <div class="form-group clearfix">
                          ...
                          <div class="radio radio-inline">
                              <input type="radio" id="inlineRadio9" value="1" name="needInsurance" checked="checked">
                              <label for="inlineRadio9"> 需要 </label>
                          </div>
                          <div class="radio radio-inline">
                              <input type="radio" id="inlineRadio10" value="0" name="needInsurance">
                      ...
                      <div class="form-group clearfix">
                          ...
                          <div class="radio radio-inline">
                              <input type="radio" id="inlineRadio11" value="1" name="needSafe" checked="checked">
                              <label for="inlineRadio11"> 需要 </label>
                          </div>
                          <div class="radio radio-inline">
                              <input type="radio" id="inlineRadio12" value="0" name="needSafe">
                  ...
                  <div class="box-footer text-center">
                      ...
                      <input type="submit" class="btn btn-success J-submit" value="添加活动">
                  </div>
              </form>
          </div>
        </div>
